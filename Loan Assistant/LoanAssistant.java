...
// frame constructor
  ...
  private void computeButtonActionPerformed (ActionEvent e)
  {
	...
	JOptionPane.showConfirmDialog (null,
				       "Invalid or empty Loan Balance entry.\nPleasecorrect.",
				       "Balance Input Error",
	...
	interest =
      ...
      {
	JOptionPane.showConfirmDialog (null,
				       "Invalid or empty Interest Rate entry.\nPleasecorrect.",
				       "Interest Input Error",
				       JOptionPane.DEFAULT_OPTION,
				       JOptionPane.INFORMATION_MESSAGE);
	return;
      }
...
// Compute loan payment
	if (validateDecimalNumber (monthsTextField))
	  ...
	  {
	    JOptionPane.showConfirmDialog (null,
					   "Invalid or empty Number of Paymentsentry.\nPlease correct.",
	...
	if (interest == 0)
	...
	else
	  {
	    ...
	    payment =
	      balance * monthlyInterest * multiplier / (multiplier - 1);
	  }
...
// Compute number of payments
	if (validateDecimalNumber (paymentTextField))
	  ...
	  {
	    JOptionPane.showConfirmDialog (null,
					   "Invalid or empty Monthly Paymententry.\nPlease correct.",
					   "Payment Input Error",
					   JOptionPane.DEFAULT_OPTION,
					   JOptionPane.INFORMATION_MESSAGE);
	    return;
	...
	if (interest == 0)
	  ...
	  {
	    months =
	      (int) ((Math.log (payment) -
		      Math.log (payment -
				balance * monthlyInterest)) / Math.log (1 +
									monthlyInterest));
	  }
...
// apply one more payment
    ...
    analysisTextArea.append ("\n" + "Final Payment of: $" +
			     ...
			     format (finalPayment));
    analysisTextArea.append ("\n" + "Total Payments: $" +
			     new DecimalFormat ("0.00").format ((months - 1) *
								payment +
								finalPayment));
    analysisTextArea.append ("\n" + "Interest Paid $" +
			     new DecimalFormat ("0.00").format ((months - 1) *
